package ch.smart.operations.platform.asset.security;
...
public class AssetSecurityConfig {
    ...
    @Bean
    public SecurityFilterChain assetSecurityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .requestMatchers(HttpMethod.PUT, "/api/v1/assets/**")
                .hasAnyRole("ADMIN", "SUPPORT_AGENT")

                .requestMatchers(HttpMethod.PATCH, "/api/v1/assets/**")
                .hasAnyRole("ADMIN", "SUPPORT_AGENT")

...
public class InvoiceRepositoryAdapter implements InvoiceRepository {
    ...
    private final Logger logger = LoggerFactory.getLogger(InvoiceRepositoryAdapter.class);
    ...
    public List<Invoice> findByStatus(InvoiceStatus status) {
        ...
        List<Invoice> result = repository.findByStatus(status).stream().map(this::toDomain).toList();
        return result;
    }

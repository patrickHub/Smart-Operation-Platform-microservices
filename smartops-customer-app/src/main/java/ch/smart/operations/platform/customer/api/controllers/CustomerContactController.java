...
public class CustomerContactController {
    ...
    @GetMapping("/api/v1/customers/{customerId}/contacts")
    public ResponseEntity<List<CustomerContactDto>> getContactsByCustomerId(@PathVariable UUID customerId) {
        List<CustomerContactDto> contacts = customerContactApplicationService.getContactsByCustomerId(customerId);
